...
impl ColoringInstance for CGSHOPInstance {
    ...
    fn degree(&self, u: VertexId) -> usize {
        self.preprocessed.as_ref().unwrap().degrees[u]
    }
...
impl CGSHOPInstance {
    ...
    pub fn from_file(filename: &str) -> Self {
        ...
        if res.preprocessed.is_none() {
            ...
            println!(
                "\t{} conflicts",
                degrees.iter().map(|e| *e as i64).sum::<i64>()
            );
            ...
            for i in 0..n {
                not_dominated.insert(i);
            }
            for i in 0..n {
                if i % 1000 == 0 {
                    println!("computing dominances ({} / {})...", i, n);
                }
                // list vertices dominated by i
                if not_dominated.contains(i) {
    ...
    pub fn write_adj_list_file(&self, filename: &str) {
        ...
        let mut file =
            File::create(filename).expect("CGHSOPSolution.to_file: unable to open the file");
...
fn are_intersecting(
    (p1, q1): &((i64, i64), (i64, i64)),
    (p2, q2): &((i64, i64), (i64, i64)),
) -> bool {
    let o1 = orientation(p1, q1, p2);
    let o2 = orientation(p1, q1, q2);
    if p1 == p2 || p1 == q2 || q1 == p2 || q1 == q2 {
        // check if same points
...
impl CGSHOPSolution {
    ...
    pub fn from_file(filename: &str) -> Self {
        let file = File::open(filename).expect("CGHSOPSolution.from_file: unable to open the file");
        let reader = BufReader::new(file);
        serde_json::from_reader(reader).expect("CGHSOPSolution.from_file: unable to serialize")
    }
...
mod tests {
    ...
    fn test_use_best_so_far() {
        let inst = CGSHOPInstance::from_file("./insts/cgshop22/rvispecn17968.instance.json");
    ...
    fn test_preprocess_merge_visp() {
        let _ = CGSHOPInstance::from_file("./insts/cgshop_22_examples/visp_5K.instance.json");
        // cg_inst.preprocess_merge();
    }

    #[test]
    fn test_preprocess_merge_visp10k() {
        let _ = CGSHOPInstance::from_file("./insts/cgshop_22_examples/visp_10K.instance.json");
        // cg_inst.preprocess_merge();
    }

    #[test]
    fn test_preprocess_merge_visp50k() {
        let _ = CGSHOPInstance::from_file("./insts/cgshop_22_examples/visp_50K.instance.json");
        // cg_inst.preprocess_merge();
    }

    #[test]
    fn test_read_reecn() {
        let _ = CGSHOPInstance::from_file("./insts/cgshop22/reecn73116.instance.json");
    }

    #[test]
    fn test_read_rsqrp() {
        let _ = CGSHOPInstance::from_file("./insts/cgshop22/rsqrp24641.instance.json");
    }

    #[test]
    fn test_read_sqrp() {
        let _ = CGSHOPInstance::from_file("./insts/cgshop22/sqrp73525.instance.json");
    }

    #[test]
    fn test_read_visp() {
        let _ = CGSHOPInstance::from_file("./insts/cgshop22/visp73369.instance.json");
    }

    #[test]
    fn test_read_vispecn() {
        let _ = CGSHOPInstance::from_file("./insts/cgshop22/vispecn74166.instance.json");
    }
    ...
    #[test]
    fn test_export2() {
        let inst = CGSHOPInstance::from_file("./insts/cgshop22/rvisp3499.instance.json");
    ...
    fn test_export_dimacs() {
        ...
        let inst =
            CGSHOPInstance::from_file(format!("./insts/cgshop22/{}.instance.json", name).as_str());
